...
>
	...
	>
		...
		<a href="/" aria-label="Gidi Tour home" onclick={closeMenu} class="flex flex-col leading-none">
			...
			<span class="text-[10px] font-bold tracking-[0.25em] text-[#FFC107]"> TOUR </span>
		</a>
		...
		<div class="flex items-center gap-2">
			...
			<a
				href="/book"
				onclick={closeMenu}
				class="flex h-10 items-center gap-1.5 rounded-full bg-[#FFC107] px-3.5 text-[11px] font-bold text-black transition active:scale-95"
			>
				Book a Tour

				<span class="flex h-5 w-5 items-center justify-center rounded-full bg-black text-[#FFC107]">
					→
				</span>
			</a>
...
{#if open}
	<div class="fixed inset-0 z-50 overflow-y-auto bg-black text-white md:hidden">
		...
		<div class="flex items-center justify-between px-5 pb-5 pt-24">
			<div>
				<p class="text-[10px] font-semibold uppercase tracking-[0.25em] text-[#FFC107]">
					Explore Gidi Tour
				</p>
		...
		<div class="px-5">
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">01</span>
					<span class="text-2xl font-semibold">Home</span>
				</div>

				<span class="text-white/30 transition group-hover:translate-x-1 group-hover:text-[#FFC107]">
					→
				</span>
			</a>
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">02</span>
					<span class="text-2xl font-semibold">Explore</span>
				</div>
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">03</span>
					<span class="text-2xl font-semibold">Destinations</span>
				</div>
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">04</span>
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">05</span>
					<span class="text-2xl font-semibold">Stories</span>
				</div>
			...
			>
				<div class="flex items-center gap-4">
					<span class="text-xs text-[#FFC107]">06</span>
					<span class="text-2xl font-semibold">About</span>
				</div>
		...
		<div class="px-5 pb-8 pt-10">
			<div class="mb-5 flex items-end justify-between">
				...
				<a href="/destinations" onclick={closeMenu} class="text-xs text-[#FFC107]"> View all → </a>
			</div>
			...
			<div class="grid grid-cols-2 gap-2">
				{#each destinations as destination}
					<a
						...
						onclick={closeMenu}
						class="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white/70 transition active:bg-[#FFC107] active:text-black"
					>
						{destination.name}
					</a>
				{/each}
		...
		<div class="px-5 pb-10">
			<a
				href="/book"
				onclick={closeMenu}
				class="group flex w-full items-center justify-between rounded-2xl bg-[#FFC107] px-5 py-4 text-black"
			>
				<div>
				...
				<span
					class="flex h-10 w-10 items-center justify-center rounded-full bg-black text-[#FFC107] transition-transform duration-300 group-hover:translate-x-1"
				>
					→
				</span>
			</a>
