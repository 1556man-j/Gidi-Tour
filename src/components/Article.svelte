<script lang="ts">
	...
	const storyList = articles.slice(0, 5);
...
<section class="bg-[#f7f3ea] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
	<div class="mx-auto max-w-[1440px]">
		<div class="reveal grid gap-8 lg:grid-cols-12 lg:items-end">
			...
			<div
				class="flex items-center justify-between gap-4 lg:col-span-4 lg:col-start-9 lg:justify-end"
			>
		...
		<div class="mt-4 flex justify-end">
			<a href="/stories" class="hidden text-xs font-bold text-[#5C9B19] sm:block"
				>Read all stories →</a
			>
		</div>
		...
		<div class="mt-8 flex items-center gap-4">
			...
			<div class="story__track" bind:this={storyTrack} onscroll={updateStoryActiveDot}>
				{#each storyList as story (story.slug)}
					<a
