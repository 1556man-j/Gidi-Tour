...
>
	...
	<div
		class="pointer-events-none absolute -right-32 -top-32 h-80 w-80 rounded-full bg-[#5C9B19]/[0.06] blur-3xl"
	></div>
	...
	<div class="relative mx-auto max-w-3xl text-center">
		<span
			class="inline-flex items-center rounded-full border border-[#5C9B19]/15 bg-white/80 px-4 py-2 text-[17px] font-bold uppercase text-[#5C9B19] shadow-sm backdrop-blur"
		>
			Contact Us
		</span>

		<h1
			class="flex flex-col mt-6 text-4xl font-bold leading-[0.98] tracking-[-0.04em] text-[#17200f] sm:text-5xl lg:text-7xl"
		>
			Let's plan
...
<!-- FORM + CONTACT INFO -->
<section
	class="bg-[#f7f3ea] px-5 pb-20 sm:px-8 sm:pb-24 lg:px-12 lg:pb-32"
	use:reveal
>
	<div class="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.35fr_0.85fr] lg:gap-8">
		...
		<!-- FORM CARD -->
		<div
			class="rounded-[28px] shadow-md bg-white p-6 shadow-[0_12px_45px_rgba(23,32,15,0.06)] sm:rounded-[32px] sm:p-8 lg:p-10"
		>
			{#if success}
				<div class="flex min-h-[480px] flex-col items-center justify-center py-12 text-center">
					<div
						class="flex h-16 w-16 items-center justify-center rounded-full bg-[#5C9B19]/10"
					>
						<svg
					...
					<h2
						class="font-display mt-6 text-3xl font-bold tracking-[-0.03em] text-[#17200f]"
					>
						Message sent!
					</h2>

					<p class="mx-auto mt-3 max-w-sm text-sm leading-6 text-[#17200f]/55">
						Thanks for reaching out. Someone from the team will get back to you within one
						business day.
					</p>
			...
			{:else}
				<div class="mb-8">
					...
					<p class="mt-3 max-w-lg text-sm leading-6 text-[#17200f]/55">
				...
				<form onsubmit={handleSubmit} novalidate class="space-y-5">
					...
					<div class="grid gap-5 sm:grid-cols-2">
						<div class="space-y-2">
							<label
								for="contact-name"
								class="block text-xs font-semibold text-[#17200f]/70"
							>
								Name
							</label>
							...
							<input
								...
								required
								autocomplete="name"
								class="h-14 w-full rounded-2xl border border-black/10 bg-[#fafafa] px-4 text-sm text-[#17200f] outline-none transition placeholder:text-[#17200f]/30 hover:border-black/20 focus:border-[#5C9B19] focus:bg-white focus:ring-4 focus:ring-[#5C9B19]/10"
							/>
						</div>
					...
					<div class="grid gap-5 sm:grid-cols-2">
						<div class="space-y-2">
							...
							>
								Phone
								<span class="font-normal text-[#17200f]/35">(optional)</span>
							</label>
					...
					<div class="space-y-2">
						...
						<textarea
							...
							rows="6"
							required
							class="min-h-[150px] w-full resize-y rounded-2xl border border-black/10 bg-[#fafafa] px-4 py-4 text-sm leading-6 text-[#17200f] outline-none transition placeholder:text-[#17200f]/30 hover:border-black/20 focus:border-[#5C9B19] focus:bg-white focus:ring-4 focus:ring-[#5C9B19]/10"
						></textarea>
					</div>
					...
					<div class="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center sm:justify-between">
						<p class="text-xs leading-5 text-[#17200f]/40">
		...
		>
			...
			<div class="relative">
				...
				<h3
					class="font-display mt-5 text-2xl font-bold tracking-[-0.03em] sm:text-3xl"
				>
					Prefer to connect elsewhere?
				</h3>

				<p class="mt-4 text-sm leading-6 text-white/55">
					Find us on social. We're usually quick to reply, and it's a great way to see recent
					trips before you book your own.
				</p>
